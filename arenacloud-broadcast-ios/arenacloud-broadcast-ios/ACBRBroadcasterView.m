...
@implementation ACBRBroadcasterView
{
...
- (void)setupUI
{
    ...
    controlsView = [[ACBRBroadcasterControlsView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height-ControlsViewHeight, self.bounds.size.width, ControlsViewHeight)];
