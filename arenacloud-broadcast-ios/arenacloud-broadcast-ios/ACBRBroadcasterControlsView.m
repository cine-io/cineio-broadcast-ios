...
#import "ACBRIconsBase64.h"

@implementation ACBRBroadcasterControlsView
...
- (id)initWithFrame:(CGRect)rect
{
    ...
    recordButton = [[ACBRRecordButtonView alloc] initWithFrame:CGRectMake(self.center.x-36, self.center.y-36, 72, 72)];
    recordButton.enabled = NO;
    [self addSubview:recordButton];
    
    // torch button
    NSString *lightningIconString = @"data:image/png;base64,";
    lightningIconString = [lightningIconString stringByAppendingString:ACBRLightningIcon];
    ...
    switchCameraIconString = [switchCameraIconString stringByAppendingString:ACBRSwitchCameraIcon];
